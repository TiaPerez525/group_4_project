...
document.getElementsByClassName('headerNavLink')[0].setAttribute('onclick', 'Header_OpenWebsite("contact.html")');
document.getElementsByClassName('headerNavLink')[1].setAttribute('onclick', 'Header_OpenWebsite("available.html")');
document.getElementsByClassName('headerNavLink')[2].setAttribute('onclick', 'Header_OpenWebsite("faqs.html")');
...
document.getElementsByClassName('li')[0].setAttribute('onclick', "Header_OpenWebsite('../pages/chinh-sach-mua-hang.html')");
document.getElementsByClassName('li')[1].setAttribute('onclick', "Header_OpenWebsite('../pages/chinh-sach-doi-tra.html')");
document.getElementsByClassName('li')[2].setAttribute('onclick', "Header_OpenWebsite('../pages/contact.html')");
document.getElementsByClassName('li')[3].setAttribute('onclick', "Header_OpenWebsite('../pages/search.html')");
