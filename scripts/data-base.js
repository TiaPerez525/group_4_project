class DataBase {
    ...
    LOGGED_IN_ACCOUNT_INDEX_SAVE_KEY = 'LoggedInAccountIndex';
    STRING_SEPERATOR = '#';
    ...
    Awake() {
        ...
        let loggedInAccountIndex = window.localStorage.getItem(this
            .LOGGED_IN_ACCOUNT_INDEX_SAVE_KEY);

        if (loggedInAccountIndex != null) 
            this.loggedInAccountIndex = loggedInAccountIndex;
    }
    ...
    HandleSetLoggedInAccountIndex(_index) {
        this.loggedInAccountIndex = _index;
        window.localStorage.setItem(this.LOGGED_IN_ACCOUNT_INDEX_SAVE_KEY, this
            .loggedInAccountIndex);
    }
}