...
function mobile_headerNavLinkMenuCloseButton_onclick() {
    header.BeginCloseMobileHeaderNavLinkMenu();
}
...
function header_faqsNavLink_onmousehover() {
    headerNavLink_onmousehover(2);
    document.getElementById('header_faqDropMenu').style.height = '120%';
}

function header_faqsNavLink_onmouseleave() {
    headerNavLink_onmouseleave(2);
    document.getElementById('header_faqDropMenu').style.height = '0%';
}

function header_faqDropMenu_onmouseenter() {
    document.getElementById('header_faqDropMenu').style.height = '120%';
}

function header_faqDropMenu_onmouseleave() {
    document.getElementById('header_faqDropMenu').style.height = '0%';
}