        ...
        this.innerHTML = `
            <footer class="footer">
                ...
                <div class="footerTextWrapper">
                    ...
                    <br>
                    <ul>
                        <li class="li li_margin-top ul_hover" onclick="Header_OpenWebsite('pages/chinh-sach-mua-hang.html')">Chính sách mua hàng</li>
                        <li class="li li_margin-top ul_hover" onclick="Header_OpenWebsite('pages/chinh-sach-doi-tra.html')">Chính sách đổi trả</li>
                        <li class="li li_margin-top ul_hover" onclick="Header_OpenWebsite('pages/contact.html')">Liên hệ</li>
                        <li class="li li_margin-top ul_hover" onclick="Header_OpenWebsite('pages/search.html')">Tìm kiếm</li>
                    </ul>
                </div>
                <br>
                <div class="footerTextWrapper">
