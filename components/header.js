class HeaderComponent extends HTMLElement {
    ...
    <nav class="headerNav">
        ...
        <div class="headerNavLink" href="" onmouseover="headerNavLink_onmousehover(2)" onmouseleave="headerNavLink_onmouseleave(2)" onclick="headerNavLink_onclick('pages/faqs.html')">
